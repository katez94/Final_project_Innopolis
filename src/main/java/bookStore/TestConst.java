...
public class TestConst {
    ...
    public static final String TEST_USER_NAME = "testUserKate1!!";
    public static final String TEST_USER_PASSWORD = "testUserKate1!!";
    public static final String ALERT_BOOK_ADDED_TEXT = "Book added to your collection.";
